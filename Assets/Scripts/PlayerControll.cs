...
public class PlayerControll : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (Input.GetKeyDown("2") && minecd <= 0)
        {
            minecd = minemaxcd;
            Vector3 mineoffset;
            mineoffset.x = Input.GetAxisRaw("Horizontal");
            mineoffset.y = 0f;
            mineoffset.z = Input.GetAxisRaw("Vertical");
        ...
        if (Input.GetKeyDown("3") && spikescd <= 0)
        {
            ...
            spikesoffset.x = Input.GetAxisRaw("Horizontal");
            spikesoffset.y = 0f;
            spikesoffset.z = Input.GetAxisRaw("Vertical");
            Rigidbody mine_clone;
